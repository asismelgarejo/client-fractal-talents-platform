...
export const customVariants = {
  ...
  contained: " text-white bg-tertiary-500 border-tertiary-500 fill-whites",
  gray_1: "bg-gray-400 border-gray-400 text-white",
  gray_2: "border-gray-400 text-gray-500",
    ...
    return (
      <button
        ...
        className={clsx(
          ...
          "border rounded-lg justify-center flex space-x-2 inline-block items-center px-5 py-2 font-medium text-sm ",
          btnProps?.className ?? ""
        )}
      >
        {children}
